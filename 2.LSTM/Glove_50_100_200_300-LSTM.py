...
# data_path = './pickle/data_embeddings_100d.pkl'
# data_path = './pickle/data_embeddings_200d.pkl'
data_path = './pickle/data_embeddings_300d.pkl'
...
df.to_excel('../predicted_data_Glove 50-100-200-300 + LSTM.xlsx',sheet_name='lstm1',index=False)